        ...
        public void hcomecc (String address, String u, String p, String size, boolean upload){
            ...
            try {
                ...
                for (int i = 0; i < times; i++) {
                    ...
                    if (upload) {
                        t += compressedTime;
                        new PCUP(true, size, t, getApplicationContext()).execute(address, u, p, enCompressedFile, destination);
                    } else {
                        t += decompressedTime;
                        new PCDN(true, size, t, getApplicationContext()).execute(address, u, p, enCompressedFile, destination);
                    }
        ...
        public void helios (String address, String u, String p, String size, boolean upload) {
            ...
            try {
                ...
                for (int i = 0; i < times; i++) {
                    ...
                    if (upload) {
                        t += compressedTime;
                        new PCUP(true, source, t, getApplicationContext()).execute(address, u, p, compressedFile, destination);
                    } else {
                        t += decompressedTime;
                        new PCDN(true, source, t, getApplicationContext()).execute(address, u, p, compressedFile, destination);
                    }
                    //Toast.makeText(getApplicationContext(), ("Compressed and decompressed in = " + t + " s"), Toast.LENGTH_LONG).show();
                }
        ...
        public void fullEncrytption  (String address, String u, String p, String size, boolean upload) {
            ...
            try{
                ...
                for(int i=0;i<times;i++) {
                    ...
                    if (upload) {
                        t += encryptionTime;
                        new PCUP(true, source, t, getApplicationContext()).execute(address, u, p, encryptedFile, destination+".sh");
                    }
                    else {
                        t += decryptionTime;
                        new PCDN(true, source, t, getApplicationContext()).execute(address, u, p, encryptedFile, destination+".sh");
                    }
